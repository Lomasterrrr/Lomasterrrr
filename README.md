...
- [aecal](https://github.com/Ae-foundation/aecal) --- иновационный календарь, с подсветкой, и на основе cal из bsd 4.2
- [aepwd](https://github.com/Ae-foundation/aepwd) --- иновационный pwd; написан чтобы попробовать написать что-нибудь в acme
